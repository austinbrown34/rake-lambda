...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/rvm/rubies/ruby-2.5.1")
  ...
  CONFIG["configure_args"] = " '--prefix=/usr/local/rvm/rubies/ruby-2.5.1' '--disable-install-doc' '--enable-shared'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/usr/local/rvm/rubies/ruby-2.5.1"
